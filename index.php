...
<script type="text/javascript">
  ...
  function setCardImgs(arrCardContents){
    ...
    for( i = 0; i < arrCardContents.length; i++){
      ...
      var imgId = "img" + i;
      document.getElementById(imgId).src = "./images/" + topicName + "/" + topicName + "-" + arrCardContents[i] + ".png";
    }
...
<div class="centerAlign"> 
  <div style="position: absolute;top: 50px; left: 90px;">
    ...
    <div style="margin-top: 10px;padding: 0px;">
      <p class="stepContent">Step2<span class="joinContent" onclick="joinToGame()">press to JOIN</span></p>
    </div>
  </div>
  <div id="gameTitle">
  ...
  <div class="GameBoard">
    <div style="float: left;">
      ...
      <div id="cmdSendInvite">Invite</div>
...
function cardClickEvent(clickedElem){
  var audio = new Audio('assets/sound-effect.mp3');
  audio.play();
  if(IsBegin == false){
    IsBegin = true;
    clearInterval(gmTime);
